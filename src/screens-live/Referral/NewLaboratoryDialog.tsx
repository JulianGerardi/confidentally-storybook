...
export interface NewLaboratoryDialogProps {
  onCancel?: () => void;
  onSave?: () => void;
  /** Cuando es true, todos los campos muestran el estilo de error (borde rojo) — reproduce el
   * frame "New Laboratory - Error" de Figma (node 850:1197), un estado de demo con todos los
   * campos inválidos a la vez, no una validación parcial realista. */
  invalid?: boolean;
}
...
/**
 * NewLaboratoryDialog — modal para dar de alta un laboratorio/proveedor nuevo.
 * Figma: UX-UI · 2.0 > Lab Order / Referral > New Laboratory (node 606:8331, estado de error 850:1197).
 * Se dispara desde el link "+ New Laboratory" en ReferralForm (y también en Lab Order).
 */
