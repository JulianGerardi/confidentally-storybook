...
const meta: Meta<typeof ClinicalBadge> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Badge de tipo/estado de consulta clinica. Figma: Design system - 2.0 > Clinical Mode > ClinicalBadge (node 254:2930). Ver tambien la variante 'Start Encounter' en `ClinicalBadgeStartEncounter`.",
      },
    },
  },
};
